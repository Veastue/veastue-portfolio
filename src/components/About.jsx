    ...
    <section id='about' className='min-h-96 max-w-4xl mx-auto flex flex-col justify-center items-center gap-[80px] lg:flex-row lg:pt-20 py-32 '>
        <div className="flex flex-col sm:flex-row">
            <div className='relative w-full'>
                <div className='overflow-hidden max-h-[250px] max-w-[350px] sm:max-w-[400px] sm:max-h-[300px] rounded-[20px] flex justify-center items-center shadow-lg '>    
        ...
        <div className='flex flex-col items-center lg:items-start gap-8 px-5 max-w-[340px]'>
            <h3 className="uppercase text-blue-600 font-extrabold ">About me</h3>
            <h1 className='text-2xl font-black text-center lg:text-start max-w-[300px] lg:w-full'>Front-end Developer from the Cavite, Philippines 📍</h1>
